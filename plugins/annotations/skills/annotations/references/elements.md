...
| `h2` | Section heading. Draws a 3px rule above itself. | `<h2>What it costs</h2>` |
| `h3` | Sub-heading inside a section. No rule. | `<h3>On writes</h3>` |
...
| `a` | Link. Underlined at 2px, inherits the ink color. | `<p>See <a href="#costs">the costs</a>.</p>` |
